\section{Introduction}
  ...
  \subimport{ecescon17/figures/}{simpleexample.tikz}
  ...
  A user has many incentives to join. First, she has access to otherwise inaccessible stores. Moreover, two friends can
