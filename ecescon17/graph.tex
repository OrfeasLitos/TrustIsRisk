\section{The Trust Graph}
  ...
  \subimport{ecescon17/definitions/}{gamegraph.tex}
  ...
  \subimport{ecescon17/figures/}{utxo.tikz}
  ...
  graph with its corresponding transactions in the UTXO can be seen in Fig.~\ref{fig:utxo}.
  ...
  \subimport{ecescon17/definitions/}{inouttrust.tex}
